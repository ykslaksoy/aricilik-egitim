...
const STRENGTH_ITEMS = [
  // ── A — Donanım (rakipte yok veya tasarım lideri) ──
  {
    ...
    sh: 0,
    hedef: 100,
    iyilestirme: "NODE+GATE LoRa + retry + 4G failover — kalite 100",
    dosya: "services/loraSensorCalibration.js",
  },
  {
    id: "gunes_pil",
    g: "A",
    ...
    sh: 94,
    hedef: 100,
    iyilestirme: "Panel+LiFePO4 + uyku + şarj tahmini — kalite 100",
    dosya: "services/powerSensorCalibration.js",
  },
  {
    id: "gate_4g",
    g: "A",
    ...
    sh: 95,
    hedef: 100,
    iyilestirme: "A7670E + offline buffer + LoRa failover — kalite 100",
    dosya: "services/cellularSensorCalibration.js",
  },
  {
    id: "ir_sayac",
    g: "A",
