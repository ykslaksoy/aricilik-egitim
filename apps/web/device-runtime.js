...
/* Ana home layout: relax existing weather card, shrink tiles ~5%, keep gaps (inline) */
(function injectAnaHomeLayout() {
  try {
    ...
    var apply = function () {
      ...
      s.textContent = [
        '.weather{flex:1 1 auto!important;min-height:0!important;padding:10px 12px 8px!important;margin-bottom:6px!important;display:flex!important;flex-direction:column!important;justify-content:space-evenly!important;gap:4px!important}',
        '.weather-top{gap:6px!important;min-height:34px!important;padding:2px 0!important;flex:0 0 auto!important}',
        ...
        '.forecast{margin-top:4px!important;flex:0 0 auto!important;padding:2px 0!important}',
        ...
        '.muayene-hint{margin-top:6px!important;flex:0 0 auto!important}',
        '.grid{flex:0 0 auto!important;grid-template-rows:repeat(4,128px)!important;gap:5px!important}',
        '.tile{border-radius:13px!important;padding:3px 2px!important}',
        ...
        '.hive-icon{top:24px!important;width:25px!important;height:25px!important}',
        '.hive-icon.hive-icon-burn{width:27px!important;height:27px!important}',
        '.tile-label{font-size:9.5px!important}',
        '.badge{padding:1px 6px!important;font-size:8.5px!important}'
      ].join('');
